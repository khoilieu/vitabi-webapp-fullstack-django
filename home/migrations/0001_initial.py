# Generated by Django 4.2.7 on 2024-07-22 07:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likelihood_ratio', models.FloatField(blank=True, help_text='Likelihood ratio for this answer if applicable.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link_map', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='insurance_photos/')),
            ],
        ),
        migrations.CreateModel(
            name='Language',
            fields=[
                ...
                ('photo', models.ImageField(default='language_photos/default.jpg', upload_to='language_photos/')),
            ],
        ),
        migrations.CreateModel(
            name='Patient',
            fields=[
                ...
                ('height_unit', models.CharField(choices=[('cm', 'cm'), ('ft', 'ft')], default='cm', max_length=2)),
                ('weight', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ('weight_unit', models.CharField(choices=[('kg', 'kg'), ('pound', 'pound')], default='kg', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hospital', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='working_hours', to='home.hospital')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='insurance_info', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='HospitalImage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_date_from', models.TimeField(default=django.utils.timezone.now)),
                ('first_date_to', models.TimeField(default=django.utils.timezone.now)),
                ...
                ('insurance_type', models.CharField(blank=True, choices=[('cashless', 'Cashless Payment Supported'), ('insurance', 'Insurance supported (NOT CASHLESS)'), ('not_insurance', 'Insurance not supported')], max_length=100, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ...
                ('suggested_hospital', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='suggested_bookings', to='home.hospital')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='symptom_checker', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='hospital',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hospital', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='distance_info', to='home.hospital')),
            ],
        ),
        migrations.CreateModel(
            name='Conclusion',
